...
const FACULTY = [
  { name: "Dr. Suvathi", email: "suvathi@college.edu", password: "Faculty@123", category: "Technical" },
  { name: "Dr. Meena",   email: "meena@college.edu",   password: "Faculty@123", category: "Cultural & Creative" },
  { name: "Dr. Ramesh",  email: "ramesh@college.edu",  password: "Faculty@123", category: "Social" },
  { name: "Dr. Priya",   email: "priya@college.edu",   password: "Faculty@123", category: "Civic" },
];
  ...
  for (const [category, names] of Object.entries(categories)) {
    ...
    for (const name of names) {
      ...
      if (exists) {
        ...
        console.log(`🔄 Club updated: ${name} → ${facultyUser.name}`);
      } else {
        await Club.create({
          name,
          category,
        ...
        console.log(`✅ Club created: ${name} → ${facultyUser.name}`);
      }
    }
  }
